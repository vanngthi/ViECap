...
from src.load_annotations import load_entities_text, load_stopwords
...
class CaptionsDataset(Dataset):
    ...
    def __init__(
        ...
        self.people_vocabs = [
            "người", "người đàn ông", "người phụ nữ", "cô gái", "cậu bé", "em bé", "thanh niên", "nữ sinh", "học sinh", "sinh viên",
            "gia đình", "ông lão", "bà lão", "cha", "mẹ", "anh trai", "chị gái", "bạn bè", "đồng đội", "huấn luyện viên", "trọng tài",
            "cổ động viên", "người xem", "khán giả", "đối thủ", "vận động viên", "cầu thủ", "tiền đạo", "hậu vệ", "thủ môn",
            "người bắt bóng", "người ném bóng", "người chuyền bóng", "người sút bóng", "người phát bóng", "người đập bóng",
            "người chạy bộ", "người đi bộ", "người đi xe đạp", "người bơi", "người trượt ván", "người chơi bóng", "người tập thể dục",
            "người đánh golf", "người chèo thuyền", "người câu cá", "người leo núi", "người chụp ảnh", "người quay phim",
            "người dọn dẹp", "người làm vườn", "người phục vụ", "người bán hàng", "người pha chế", "người đầu bếp", "người cảnh sát",
            "người lính", "người cứu hộ", "người lao công", "người hướng dẫn viên", "người thợ mộc", "người thợ điện",
            "người thợ hàn", "người xây dựng", "người gác cổng"
        ]
